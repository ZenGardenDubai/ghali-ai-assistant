...
- SAME-MESSAGE image + style caption: when the user sends a photo WITH a caption requesting a style, effect, or transformation (e.g. "make ghibli style", "turn into manga", "oil painting effect", "add anime filter", "make it look like a cartoon"), ALWAYS treat it as image editing — pass the [File storageId: ...] from the message context as referenceImageStorageId. Do NOT generate a brand-new image in these cases.
