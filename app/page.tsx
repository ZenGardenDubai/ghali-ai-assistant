    ...
    <section className="relative px-6 py-24 md:py-32">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          {/* Card 4 — One Assistant (wide, with use cases) */}
          <Link href="/features/smart-ai" className="group relative overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 transition-all hover:border-[#ED6B23]/30 hover:bg-white/[0.04] lg:col-span-2">
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-[#ED6B23]/10 text-2xl">
              <SparklesIcon />
            </div>
            <h3 className="font-[family-name:var(--font-display)] text-2xl">
