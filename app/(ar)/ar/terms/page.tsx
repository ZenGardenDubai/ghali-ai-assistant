      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="space-y-8">
          ...
          <Section title="2. وصف الخدمة">
            <p>
              ghali.ae هو مساعد ذكاء اصطناعي على تيليجرام تم تطويره وتشغيله بواسطة <strong className="text-white/80">شركة ساهم لتكنولوجيا البيانات</strong> لمساعدتك في إنجاز مهامك.
          ...
          <Section title="3. تسجيل الحساب">
            ...
            <ul className="list-disc pr-6 space-y-2">
              ...
              <li>أن يكون لديك حساب تيليجرام صالح</li>
