...
const TELEGRAM_URLS = {
  en: "https://t.me/GhaliBot",
  ar: "https://t.me/GhaliBot",
} as const;
...
const FEATURE_DISPLAY: Record<FeatureSlug, { icon: string; en: { title: string; desc: string }; ar: { title: string; desc: string } }> = {
  ...
  "zero-friction": {
    icon: "\uD83D\uDCF1",
    en: { title: "Zero Friction", desc: "No app, no account. Just open Telegram and start chatting." },
    ar: { title: "\u0628\u062F\u0648\u0646 \u062A\u0639\u0642\u064A\u062F", desc: "\u0628\u062F\u0648\u0646 \u062A\u0637\u0628\u064A\u0642\u060C \u0628\u062F\u0648\u0646 \u062D\u0633\u0627\u0628. \u0628\u0633 \u0627\u0641\u062A\u062D \u062A\u064A\u0644\u064A\u063A\u0631\u0627\u0645 \u0648\u0627\u0628\u062F\u0623." },
  },
  "personal-memory": {
    icon: "\uD83E\uDDE0",
...
export function FeaturePage({
  ...
  const whatsappUrl = TELEGRAM_URLS[locale];
