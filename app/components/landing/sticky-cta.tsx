...
export function StickyCta({ t }: { t: TranslationDict }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 rtl:right-auto rtl:left-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#229ED9] text-white shadow-lg shadow-[#229ED9]/30 transition-transform hover:scale-110 animate-[bounce-in_0.5s_ease-out]"
    >
