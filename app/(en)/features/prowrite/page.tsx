...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: { en: "https://ghali.ae/features/prowrite", ar: "https://ghali.ae/ar/features/prowrite", "x-default": "https://ghali.ae/features/prowrite" },
  },
  openGraph: {
...
const pageJsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      "@type": "FAQPage",
      mainEntity: [
    { "@type": "Question", name: "What is ProWrite?", acceptedAnswer: { "@type": "Answer", text: "ProWrite is Ghali's professional writing feature. Say 'prowrite' followed by your topic, and 8 AI models will research, outline, draft, critique, and polish your content." } },
    { "@type": "Question", name: "What can I write with ProWrite?", acceptedAnswer: { "@type": "Answer", text: "Articles, blog posts, emails, proposals, reports, social media content, creative writing — any professional content that benefits from a multi-step AI pipeline." } },
    { "@type": "Question", name: "How many AI models does ProWrite use?", acceptedAnswer: { "@type": "Answer", text: "ProWrite uses 8 AI models in sequence. Each model handles a specific step: research, outlining, drafting, critiquing, revising, fact-checking, polishing, and final review." } },
      ],
    },
  ],
};
...
export default function ProWritePage() {
  return (
    <FeaturePage
      jsonLd={pageJsonLd}
      slug="prowrite"
      alternateLocaleHref="/ar/features/prowrite"
      badge="ProWrite"
