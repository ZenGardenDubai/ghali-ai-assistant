...
export const metadata: Metadata = {
  title: "No App Needed — AI Assistant on Telegram",
  description:
    "No app to install. No account to create. Just open Telegram and start chatting with Ghali.",
  alternates: {
...
const pageJsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      "@type": "FAQPage",
      mainEntity: [
    { "@type": "Question", name: "Do I need to install an app to use Ghali?", acceptedAnswer: { "@type": "Answer", text: "No. Ghali works entirely through Telegram (formerly available on WhatsApp). Just message @GhaliSmartBot on Telegram and start chatting." } },
    { "@type": "Question", name: "Do I need to create an account?", acceptedAnswer: { "@type": "Answer", text: "No account, no signup, no password. Your Telegram account is your identity. Just message and go." } },
...
export default function ZeroFrictionPage() {
  return (
    <FeaturePage
      ...
      badge="Zero Friction"
      title={<>No Extra App. No Signup. <span className="text-[#ED6B23]">Just Message.</span></>}
    ...
    >
      <FeatureSection title="Open Telegram. Say Hi. Done.">
        <p>
      ...
      <FeatureSection title="Why this matters">
        <div className="grid gap-4 sm:grid-cols-2">
          <FeatureCard
            ...
            description="Works on any phone with Telegram. Android, iPhone, even Telegram Desktop."
          />
          <FeatureCard
            icon="🔑"
            title="No account to create"
            description="Your Telegram account is your identity. No passwords, no email verification."
          />
          <FeatureCard
            icon="🔄"
          ...
          <FeatureCard
            ...
            description="Telegram works on slow connections, old phones, and in every country. So does Ghali."
          />
        </div>
      </FeatureSection>
