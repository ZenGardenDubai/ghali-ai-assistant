...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: { en: "https://ghali.ae/features/scheduled-tasks", ar: "https://ghali.ae/ar/features/scheduled-tasks", "x-default": "https://ghali.ae/features/scheduled-tasks" },
  },
  openGraph: {
...
const pageJsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      "@type": "FAQPage",
      mainEntity: [
    { "@type": "Question", name: "What kinds of tasks can I schedule?", acceptedAnswer: { "@type": "Answer", text: "You can schedule daily briefings, reminders, recurring reports, weather updates, news summaries, and any other AI-powered task that runs automatically." } },
    { "@type": "Question", name: "How precise is the scheduling?", acceptedAnswer: { "@type": "Answer", text: "Scheduled tasks have hourly precision. You can set tasks for specific hours, and they'll run within that hour window." } },
    { "@type": "Question", name: "Can I cancel scheduled tasks?", acceptedAnswer: { "@type": "Answer", text: "Yes. Send 'clear schedules' to Ghali to remove all your scheduled tasks, or manage individual tasks through conversation." } },
      ],
    },
  ],
};
