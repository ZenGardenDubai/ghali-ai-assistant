...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: { en: "https://ghali.ae/features/understand-anything", ar: "https://ghali.ae/ar/features/understand-anything", "x-default": "https://ghali.ae/features/understand-anything" },
  },
  openGraph: {
...
const pageJsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      "@type": "FAQPage",
      mainEntity: [
    { "@type": "Question", name: "What types of media can Ghali understand?", acceptedAnswer: { "@type": "Answer", text: "Ghali can process images (JPEG, PNG, WebP, HEIC), audio files (MP3, WAV, OGG, AAC), video files (MP4, WebM), voice notes, and PDF documents." } },
    { "@type": "Question", name: "Can Ghali transcribe voice notes?", acceptedAnswer: { "@type": "Answer", text: "Yes. Send a voice note and Ghali will understand the content and respond to it, just like a text message." } },
    { "@type": "Question", name: "Can Ghali analyze photos?", acceptedAnswer: { "@type": "Answer", text: "Yes. Send any photo and Ghali can describe what it sees, read text in images, analyze charts, identify objects, and more." } },
      ],
    },
  ],
};
