...
export const en: TranslationDict = {
  ...
  pricing: {
    ...
    pro: {
      ...
      features: [
        { text: "600 messages per month (10x Basic)", highlight: true },
  ...
  start: {
    ...
    trust: "Free \u00B7 No signup \u00B7 60 messages/month",
    switchLocale: "\u0639\u0631\u0628\u064A",
...
export const ar: TranslationDict = {
  ...
  pricing: {
    ...
    pro: {
      ...
      features: [
        { text: "600 \u0631\u0633\u0627\u0644\u0629 \u0634\u0647\u0631\u064A\u0627\u064B (10x Basic)", highlight: true },
  ...
  start: {
    ...
    trust: "\u0645\u062C\u0627\u0646\u064A \u00B7 \u0628\u062F\u0648\u0646 \u062A\u0633\u062C\u064A\u0644 \u00B7 60 \u0631\u0633\u0627\u0644\u0629/\u0634\u0647\u0631",
