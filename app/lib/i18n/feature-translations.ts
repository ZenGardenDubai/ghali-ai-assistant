...
> = {
  "smart-ai": {
    ...
    ar: {
      ...
      metaDescription:
        "غالي يستخدم Google Gemini وAnthropic Claude وOpenAI — ويختار أفضل نموذج لكل مهمة تلقائياً.",
      sections: [
        {
          title: "ليش عدة نماذج؟",
          paragraphs: [
  ...
  "zero-friction": {
    ...
    ar: {
      ...
      metaDescription:
        "بدون تطبيق للتحميل، بدون حساب للإنشاء. غالي يعمل بالكامل عبر واتساب — بس ارسل رسالة وابدأ.",
      sections: [
        {
  ...
  "personal-memory": {
    ...
    ar: {
      ...
      metaDescription:
        "غالي يتذكر تفضيلاتك وسياقك وأسلوبك. يصير أذكى كل ما استخدمته.",
      sections: [
        {
          title: "فعلاً يتذكرك",
          paragraphs: [
  ...
  "understand-anything": {
    ...
    ar: {
      ...
      metaDescription:
        "ارسل صور، رسائل صوتية، فيديوهات، وملفات صوتية عبر واتساب. غالي يفهم كل أنواع الوسائط.",
      sections: [
        {
  ...
  "image-generation": {
    ...
    ar: {
      ...
      metaTitle: "إنشاء صور",
      metaDescription:
        "وصّف اللي تبيه واحصل على صور مذهلة بالذكاء الاصطناعي مباشرة في محادثة واتساب.",
      sections: [
        {
  ...
  documents: {
    ...
    ar: {
      ...
      metaDescription:
        "ارسل ملفات PDF ووورد وجداول بيانات عبر واتساب. غالي يحللها ويحفظها في قاعدة معرفتك الشخصية.",
      sections: [
        {
  ...
  "scheduled-tasks": {
    ...
    ar: {
      ...
      metaDescription:
        "جدول مهام وغالي ينفذها تلقائياً — ملخصات صباحية، تذكيرات، تقارير دورية تُسلّم على واتساب.",
      sections: [
        {
  ...
  "track-everything": {
    ...
    ar: {
      ...
      metaDescription:
        "تابع المصاريف والمهام وجهات الاتصال والملاحظات — قول لغالي وينظم كل شي في مكان واحد.",
      sections: [
        {
          title: "بس قول لغالي",
          paragraphs: [
  ...
  prowrite: {
    ...
    ar: {
      ...
      metaTitle: "ProWrite",
      metaDescription:
        "قول \"prowrite\" وغالي ينسق خط إنتاج كتابة متعدد النماذج لمحتوى احترافي.",
      sections: [
        {
          title: "كيف يعمل",
          paragraphs: [
  ...
  "open-source": {
    ...
    ar: {
      ...
      metaDescription:
        "غالي مفتوح المصدر. اقرأ كل سطر كود وشوف بالضبط كيف بياناتك تُعالج.",
      sections: [
        {
